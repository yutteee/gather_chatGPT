...
exports.SocialRoomInfo = {
    [SocialRoom.HipToBeSquare]: {
        caption: "Capture the most tiles for your team in this colorful competition. Look out for treasure chests—they may hold power-ups or debuffs!",
    ...
    [SocialRoom.GoKarts]: {
        caption: "Do all your friends call you Speed Racer? If not, do you want them to?! Find your inner Formula 1 driver in the Gather grand prix. Watch out for cones and boosts!",
        ...
        active: true,
        infoModalNextTitle: "Pick a go-kart and get ready!",
        infoModalNextText: "Press X to get on a go-kart, and wait for other players to join before starting the Grand Prix!",
    ...
    [SocialRoom.SpeedGathering]: {
        caption: "Discover unknown soulmates and shared experiences with our Speed Gathering space! Participants pair up and answer quick conversation starters, then switch seats to chat with a new partner every few minutes.",
    ...
    [SocialRoom.TetrisTournament]: {
        caption: "Are you a master of spatial reasoning? Test your prowess against your friends in our Jstris Tournament space!",
    ...
    [SocialRoom.Trivia]: {
        caption: "Nothing brings a group together like separating them out into teams for a trivia battle!",
    ...
    [SocialRoom.Poker]: {
        caption: "Can you fool Sam from HR into believing you have a pet turtle named Gonzo? Test your poker face in the Gather poker room.",
    ...
    [SocialRoom.TalentShow]: {
        caption: "Are you an expert ribbon dancer or knife juggler? Step into the spotlight and show off your skills in a Gather talent show.",
    ...
    [SocialRoom.BoardGames]: {
        caption: "Get together for a board game night! Choose from a variety of fun games including Draw Battle, Tetris, Codenames, and more!",
        ...
        active: true,
        infoModalNextTitle: "Join a game table",
        infoModalNextText: "Find a table and press X on the game object to set up a game.",
