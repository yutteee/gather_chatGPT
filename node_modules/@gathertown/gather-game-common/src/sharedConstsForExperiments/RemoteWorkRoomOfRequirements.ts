...
type SocialRoomType = {
  ...
  active: boolean;
  infoModalNextTitle?: string;
  infoModalNextText?: string;
...
export const SocialRoomInfo: {
  ...
  [SocialRoom.GoKarts]: {
    caption:
      "Do all your friends call you Speed Racer? If not, do you want them to?! Find your inner Formula 1 driver in the Gather grand prix. Watch out for cones and boosts!",
    imageURL:
    ...
    infoModalNextText:
      "Press X to get on a go-kart, and wait for other players to join before starting the Grand Prix!",
  ...
  [SocialRoom.SpeedGathering]: {
    caption:
      "Discover unknown soulmates and shared experiences with our Speed Gathering space! Participants pair up and answer quick conversation starters, then switch seats to chat with a new partner every few minutes.",
    imageURL:
  ...
  [SocialRoom.TetrisTournament]: {
    caption:
      "Are you a master of spatial reasoning? Test your prowess against your friends in our Jstris Tournament space!",
    imageURL:
  ...
  [SocialRoom.Trivia]: {
    caption:
      "Nothing brings a group together like separating them out into teams for a trivia battle!",
    imageURL:
  ...
  [SocialRoom.BoardGames]: {
    caption:
      "Get together for a board game night! Choose from a variety of fun games including Draw Battle, Tetris, Codenames, and more!",
    imageURL:
