...
function verifyMapIsComplete(map) {
    const verifyMapIsCompleteHelper = (map) => {
        if (map.id != null &&
            ...
            map.portals != null &&
            map.announcer != null) {
            return Object.assign(Object.assign({}, map), { id: map.id, dimensions: map.dimensions, collisions: map.collisions, backgroundImagePath: map.backgroundImagePath, spawns: map.spawns, portals: map.portals, announcer: map.announcer });
        }
        return null;
    };
